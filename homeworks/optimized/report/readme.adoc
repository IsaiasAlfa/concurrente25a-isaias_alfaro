...
Finalmente, se implementó una estrategia híbrida: se utiliza un solo hilo cuando las matrices son pequeñas y múltiples hilos solo cuando las matrices son grandes. Esto permitió aprovechar lo mejor de ambos enfoques, reduciendo el tiempo de ejecución a 56.060 segundos.
