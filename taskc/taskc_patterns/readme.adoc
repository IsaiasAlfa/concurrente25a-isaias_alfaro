...
+
****
*Respuesta*: 10000, esto se logra que los hilos sean serializados, como por ejemplo solo una CPU.
****
...
****
*Respuesta*: 100: 
Concurrencia perfecta, todos acceden y dan el mismo valor a la variable compartida.
Cuando se crean 100 hilos, un solo hilo quedo con su variable local en 0 y sobreescribe la variable count con este 0 luego de que todos los 99 hilos terminaran.
****
...
*Respuesta*: hello_order_semaphore
...
[source,delphi,linenums]
----
include::sem_barrier_reusable2.pseudo[]
----

Otra variacion de una barrera reusable es 

[source,delphi,linenums]
----
include::sem_barrier_pass_reusable.pseudo[]
----